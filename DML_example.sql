...
INSERT INTO classroom VALUES (1, 2, 20);
INSERT INTO classroom VALUES (2, 2, 30);
...
-- INSERT INTO teacher (teacher_number, name, tel_number) VALUES ('2000060201', '김선달', '010-2222-3333');
-- 이렇게 써도 되지만 동일한 포멧을 따라가는 것이 더 좋다.
...
SELECT class_room_number, seats FROM classroom WHERE seats >= 25;
